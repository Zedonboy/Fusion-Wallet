...
// These functions are ignored because they are not marked as `pub`: `create_index_service`, `create_wallet_token`, `new`, `verify_index`
...
abstract class IcWalletService implements RustOpaqueInterface {
  ...
  Future<BigInt> icpAccountIdSend({required String to, required BigInt amount});
