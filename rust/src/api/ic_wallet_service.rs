...
impl ICWalletService {
    ...
    #[flutter_rust_bridge::frb(sync)]
    pub fn create_notification_service(&self) -> anyhow::Result<NotificationService> {
        let service = NotificationService::new(self.ic_agent.clone());
        Ok(service)
    }
