...
const qr_data = document.getElementById('qr_data') as HTMLInputElement;

const qr_data_value = qr_data.value;

qrcode.toCanvas(document.getElementById('qrcode') as HTMLCanvasElement, qr_data_value)