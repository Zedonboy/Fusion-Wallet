          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Fusion Wallet Documentation
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Comprehensive documentation for Fusion Wallet, the leading
                cryptocurrency wallet solution.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="https://fusionwallet.me">Get started</Button>
                <Button href="https://github.com/Zedonboy/Fusion-Wallet" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
